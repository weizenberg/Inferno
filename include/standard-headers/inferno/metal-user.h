...
#define INFERNO_METAL_USER_VERSION 5U
 ...
 * Flags, options and reserved are zero in version 5. No native C struct is the
 * ABI.
 */
enum {
 ...
 * bit (1U << opcode). Flags are zero in version 5.
 */
enum {
